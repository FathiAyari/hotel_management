                                ...
                                <tr>
                                    ...
                                    <td class="project-actions justify-content-center d-flex ">
                                      ...
                                      <div class="d-flex flex-row">
                                          <div class="col">
                                              <a href="{{route("mark",$res->id)}}" class="btn btn-primary">   <i class="fa fa-check"></i>Terminer</a>

                                             {{-- <form action="{{ route('reservations.markAsDone',$res) }}" method="POST">
                                              @method('DELETE')
                                              @csrf
